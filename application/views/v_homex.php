...
<body>
  ...
  <header id="header">
    <div class="container d-flex">
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>Tgi</span></a></h1>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      ...
      <h2>Kolam renang, waterboom, outbound dan area bermain</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch" data-aos="fade-right">
            <a href="https://www.youtube.com/watch?v=HSCK5l6VQBo" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h4 data-aos="fade-up">Mari lebih dekat engan kami</h4>
            <h3 data-aos="fade-up">Tentang tirta guwo indah</h3>
            <p data-aos="fade-up">Sejarah kolam renang tirta guwo indah
              kolam renang tersebut awalnya dibangun untuk pribadi, namun banyak masyarakat yang berkunjung, akhirnnya dibuat kolam renang untuk umum
              .</p>
            <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-plane></i></div>
              <h4 class="title"><a href="">Visi</a></h4>
              <p class="description">Menjadikan tempat wisata kolam renang yang berkualitas tinngi yang penuh dengan keindahan alam yg asri dan eksotik yg bertujuan untuk menghibur para konsumen yg memiliki hoby berenang.</p>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up">
            <div class="card" style="background-image: url(assets/img/values-1.jpg);">
              <div class="card-body">
                <h5 class="card-title"><a href=""><?php echo $post_judul;?></a></h5>
